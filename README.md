...
[![How to upload or download files using a Dockerized SFTP server](https://ytcards.demolab.com/?id=RI3U6Rk4Fmo&title=How+to+upload+or+download+files+using+a+Dockerized+SFTP+server&lang=en&timestamp=1713794932&background_color=%230d1117&title_color=%23ffffff&stats_color=%23dedede&max_title_lines=1&width=250&border_radius=5 "How to upload or download files using a Dockerized SFTP server")](https://www.youtube.com/watch?v=RI3U6Rk4Fmo)
[![How to Set Up an SFTP Server in Docker with SSH Key Authentication](https://ytcards.demolab.com/?id=YWaSJ3fiQhE&title=How+to+Set+Up+an+SFTP+Server+in+Docker+with+SSH+Key+Authentication&lang=en&timestamp=1712285982&background_color=%230d1117&title_color=%23ffffff&stats_color=%23dedede&max_title_lines=1&width=250&border_radius=5 "How to Set Up an SFTP Server in Docker with SSH Key Authentication")](https://www.youtube.com/watch?v=YWaSJ3fiQhE)
[![PeopleSoft - A utility to search for text in all PS Queries](https://ytcards.demolab.com/?id=artdoXdajfA&title=PeopleSoft+-+A+utility+to+search+for+text+in+all+PS+Queries&lang=en&timestamp=1680531299&background_color=%230d1117&title_color=%23ffffff&stats_color=%23dedede&max_title_lines=1&width=250&border_radius=5 "PeopleSoft - A utility to search for text in all PS Queries")](https://www.youtube.com/watch?v=artdoXdajfA)
[![PeopleSoft - A Utility to find the navigation of a component](https://ytcards.demolab.com/?id=CuiPtyDfxXg&title=PeopleSoft+-+A+Utility+to+find+the+navigation+of+a+component&lang=en&timestamp=1678136724&background_color=%230d1117&title_color=%23ffffff&stats_color=%23dedede&max_title_lines=1&width=250&border_radius=5 "PeopleSoft - A Utility to find the navigation of a component")](https://www.youtube.com/watch?v=CuiPtyDfxXg)
[![PeopleSoft - Utility to retrieve SQL Code from PS Query](https://ytcards.demolab.com/?id=sNSffemuYDI&title=PeopleSoft+-+Utility+to+retrieve+SQL+Code+from+PS+Query&lang=en&timestamp=1678136713&background_color=%230d1117&title_color=%23ffffff&stats_color=%23dedede&max_title_lines=1&width=250&border_radius=5 "PeopleSoft - Utility to retrieve SQL Code from PS Query")](https://www.youtube.com/watch?v=sNSffemuYDI)
<!-- END YOUTUBE-CARDS -->
